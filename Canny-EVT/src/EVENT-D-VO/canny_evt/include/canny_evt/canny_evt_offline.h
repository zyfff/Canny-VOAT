#ifndef CANNY_EVT_SYSTEM_H
#define CANNY_EVT_SYSTEM_H
...
#include <canny_evt/canny_evt_optimization.h>
#include <canny_evt/canny_evt_types.h>
...
Eigen::Vector3d logAndTheta(const Eigen::Matrix3d & R);
/* get verbose */
bool getVerbose();
/* set verbose true */
void setVerbose();
